...
var retetele = [{
  ...
  Ingrediente: ['🍝 paste', '🥚 ouă', '🥓 bacon', '🧀 brânză dură', '🌶️ piper'],
  ...
  Nume: 'Peste alb la cuptor cu lămâie',
  ...
  Ingrediente: ['🥩 carne de vită', '🫘 fasole boabe', '🧅 ceapă', '🍅 roșii', '🧄 usturoi', '🌶️ ardei', '🍚 orez'],
